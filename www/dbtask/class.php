...
function getBooksByAuthor($author){
	$this->query = "SELECT * FROM books WHERE books.author_id = $author";
	$this->u = mysql_query($this->query);
	while ($this->books = mysql_fetch_array($this->u)){
?>
<tr align="center">
...
function getBooksByGenre($genre){
	$this->query = "SELECT * FROM books WHERE books.genre_id = $genre";
	$this->u = mysql_query($this->query);
	while ($this->books = mysql_fetch_array($this->u)){
?>
<tr align="center">
...
function getBooksByPublisher($publisher){
	$this->query = "SELECT * FROM books WHERE books.publisher_id = $publisher";
	$this->u = mysql_query($this->query);
	while ($this->books = mysql_fetch_array($this->u)){
?>
<tr align="center">
...
function getAuthorsByNationality($country){
	$this->query = "SELECT * FROM authors WHERE authors.country_id = $country";
	$this->u = mysql_query($this->query);
	while ($this->authors = mysql_fetch_array($this->u)){
?>
<tr align="center">
